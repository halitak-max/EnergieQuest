<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="text-center">
            <x-input-label for="email" :value="__('E-Maill')" />
        ...
        <div class="flex flex-col items-end mt-4 space-y-2">
            ...
            <div class="w-full mt-4">
                ...
                <a href="{{ route('auth.google') }}" class="w-full mt-4 flex items-center justify-center gap-3 px-4 py-2 bg-white border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition">
                ...
                <a href="{{ route('auth.facebook') }}" class="w-full mt-3 flex items-center justify-center gap-3 px-4 py-2 bg-white border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition">
